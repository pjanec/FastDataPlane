...
using ModuleHost.Core.Time; // For TimeConfig/GlobalTime
...
namespace FDP.Toolkit.Time.Tests
{
    public class TimeControllerStepTests
    {
        ...
        public void KernelStepFrame_AdvancesGlobalTime()
        {
            ...
            var steppedController = new SteppedMasterController(repo.Bus, new System.Collections.Generic.HashSet<int>(), new TimeConfig());
            
            kernel.SetTimeController(steppedController);
            kernel.Initialize();
